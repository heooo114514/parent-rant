  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#f0f0f0] p-4 font-mono">
      <div className="border-2 border-black bg-white p-12 text-center shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        ...
        <Link 
          href="/"
          className="inline-block border-2 border-black bg-[#00ff00] px-8 py-4 text-xl font-black text-black transition-all hover:translate-y-1 hover:shadow-[4px_4px_0_0_black] hover:bg-white"
        >
          GO BACK HOME
        </Link>
      </div>
