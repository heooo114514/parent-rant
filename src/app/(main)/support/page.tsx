  ...
  return (
    <main className="container mx-auto max-w-4xl px-4 py-12 font-mono">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        {/* WeChat Pay */}
        <div className="flex flex-col items-center border-2 border-black bg-white p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          <div className="mb-6 border-2 border-black bg-[#2aad67] p-3 text-white shadow-[4px_4px_0_0_black]">
          ...
          <h3 className="mb-6 text-xl font-black text-black uppercase">微信支付</h3>
          <div className="aspect-square w-64 bg-gray-100 flex items-center justify-center border-2 border-dashed border-black relative group hover:border-solid hover:shadow-[4px_4px_0_0_black] transition-all">
            {/* 
            ...
            */}
            ...
            />
            <span className="hidden text-gray-500 font-bold absolute text-center px-4 uppercase">
              暂未配置收款码
            </span>
          </div>
          <p className="mt-4 text-sm font-bold text-gray-600 uppercase">打开微信扫一扫</p>
        </div>

        {/* Alipay */}
        <div className="flex flex-col items-center border-2 border-black bg-white p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          <div className="mb-6 border-2 border-black bg-[#1677ff] p-3 text-white shadow-[4px_4px_0_0_black]">
          ...
          <h3 className="mb-6 text-xl font-black text-black uppercase">支付宝</h3>
          <div className="aspect-square w-64 bg-gray-100 flex items-center justify-center border-2 border-dashed border-black relative group hover:border-solid hover:shadow-[4px_4px_0_0_black] transition-all">
            {/* 
              Use a real image path. Users should place their QR codes in public/images/ 
          ...
          <p className="mt-4 text-sm font-bold text-gray-600 uppercase">打开支付宝扫一扫</p>
        </div>
      </div>
